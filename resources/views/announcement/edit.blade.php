        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card  shadow">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('announcement.update', $announcement) }}" autocomplete="off">
                        @csrf
                        @method('put')
                        <input type="hidden" name="id" value="{{ old('id', $announcement->id) }}">
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-first-name">{{ __('Who') }}</label>
                                <input type="text" name="who" id="input-first-name"
                                    class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('who', $announcement->who) }}"
                                    required
                                    autofocus>
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="what" id="input-first-name"
                                    class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('what', $announcement->what) }}"
                                    required
                                    autofocus>
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="where" id="input-first-name"
                                    class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" required value="{{ old('where', $announcement->where) }}"
                                    autofocus>
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" data-target="#reservationdatetime" name="when" value="{{ old('when', $announcement->when) }}" required/>
